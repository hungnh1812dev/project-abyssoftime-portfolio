...
export const CvHeader = ({ contact, position, hideAvatar }: CvHeaderProps) => {
  return (
    <header className="mb-4 flex items-center gap-5 border-b border-border/40 pb-4 sm:gap-6">
      ...
      <div className={`min-w-0 flex-1 ${hideAvatar ? "text-center" : ""}`}>
        ...
        <div className={`mt-2.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-foreground/65 sm:text-sm ${hideAvatar ? "justify-center" : ""}`}>
