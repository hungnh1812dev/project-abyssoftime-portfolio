...
export function HomeSkills({ items, title }: HomeSkillsProps) {
  return (
    <section id="skills" aria-labelledby="skills-title" className="border-t border-border/40 py-20 sm:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <h2 id="skills-title" className="mb-10 text-2xl font-semibold tracking-tight">{title}</h2>
