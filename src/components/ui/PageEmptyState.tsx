...
export function PageEmptyState() {
  return (
    <div className="flex min-h-screen flex-col">
      {/* Skeleton */}
      <div className="mx-auto w-full max-w-4xl animate-pulse space-y-8 px-6 py-16">
      ...
      <div className="fixed inset-x-0 bottom-0 flex justify-center pb-8">
        <div className="mx-4 flex max-w-sm flex-col items-center gap-3 rounded-xl border bg-background/95 px-6 py-4 shadow-lg backdrop-blur-sm">
